...
Monobehavior component for building and controlling forward and backward tween animation sequences, supporting play, stop, toggle, and reset operations with event integration.
This component allow to test a preview of the tween sequence in the editor mode.
